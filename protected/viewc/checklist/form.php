            ...
            <div class="col-xs-12 col-md-12">
                <div class="card-body card-block">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-xs-6 col-sm-3">
                            ...
                            <div class="input-group">
                                <input class="form-control pull-right" type="number" name="kilometraje" id="kilometraje" required>
                            </div>
                        </div>
                        <!--Placa-->
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                            ...
                                            <td>
                                                <div class="input-group">
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="1" id="lucesextok" value="OK" required>
                                                        <label class="form-check-label" for="lucesextok">OK</label>

                                                        <input class="form-check-input" type="radio" name="1" id="lucesextobs" value="Fallo">
                                        ...
                                        <tr id="observacionluzexterna" style="display:none">
                                            <td colspan="2">
                                                <input type="text" class="form-control pull-right" name="observacion1" placeholder="Escriba la observacion" id="1">
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-group">
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="2" id="lucesokint" value="OK" required>
                                                        <label class="form-check-label" for="lucesokint">OK</label>

                                                        <input class="form-check-input" type="radio" name="2" id="lucesintobs" value="Fallo">
                                        ...
                                        <tr id="observacionluzinterna" style="display:none">
                                            <td colspan="2">
                                                <input class="form-control" type="text" name="observacion2" placeholder="Escriba la observacion" id="2">
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-group">
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="3" id="llantasvehiok" value="OK" required>
                                                        <label class="form-check-label" for="llantasvehiok">OK</label>

                                                        <input class="form-check-input" type="radio" name="3" id="llantasvehiobs" value="Fallo">
                                        ...
                                        <tr id="observacionllantavehiculo" style="display:none">
                                            <td colspan="2">
                                                <input class="form-control" type="text" name="observacion3" placeholder="Escriba la observacion" id="3">
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-group">
                                                    <input class="form-check-input" type="radio" name="4" id="llantarepuok" value="OK" required>
                                                    <label class="form-check-label" for="llantarepuok">OK</label>

                                                    <input class="form-check-input" type="radio" name="4" id="llantasrepuobs" value="Fallo">
                                        ...
                                        <tr id="observacionllantarepuesto" style="display:none">
                                            <td colspan="2">
                                                <input class="form-control" type="text" name="observacion4" placeholder="Escriba la observacion" id="4">
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="5" id="nivelaceok" value="OK" required>
                                                    <label class="form-check-label" for="nivelaceok">En nivel</label>

                                                    <input class="form-check-input" type="radio" name="5" id="nivelaceobs" value="Fallo">
                                    ...
                                    <tr id="observacionnivelaceite" style="display:none">
                                        <td colspan="2">
                                            <input class="form-control" type="text" name="observacion5" placeholder="Escriba la observacion" id="5">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Refrigerante</td>
                                        <td>
                                            <div class="input-group">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="6" id="nivelrefriok" value="OK" required>
                                                    <label class="form-check-label" for="nivelrefriok">En nivel</label>

                                                    <input class="form-check-input" type="radio" name="6" id="nivelrefriobs" value="Fallo">
                                    ...
                                    <tr id="observacionnivelrefrigerante" style="display:none">
                                        <td colspan="2">
                                            <input class="form-control" type="text" name="observacion6" placeholder="Escriba la observacion" id="6">
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="7" id="nivelliqfrenok" value="OK" required>
                                                    <label class="form-check-label" for="nivelliqfrenok">En nivel</label>

                                                    <input class="form-check-input" type="radio" name="7" id="nivelliqfrenobs" value="Fallo">
                                    ...
                                    <tr id="observacionnivelliquidofreno" style="display:none">
                                        <td colspan="2">
                                            <input class="form-control" type="text" name="observacion7" placeholder="Escriba la observacion" id="7">
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="8" id="niveldirok" value="OK" required>
                                                    <label class="form-check-label" for="niveldirok">En nivel</label>

                                                    <input class="form-check-input" type="radio" name="8" id="niveldirobs" value="Fallo">
                                    ...
                                    <tr id="observacionniveldireccion" style="display:none">
                                        <td colspan="2">
                                            <input class="form-control" type="text" name="observacion8" placeholder="Escriba la observacion" id="8">
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="9" id="correasok" value="OK" required>
                                                    <label class="form-check-label" for="correasok">OK</label>

                                                    <input class="form-check-input" type="radio" name="9" id="correasobs" value="Fallo">
                                    ...
                                    <tr id="observacioncorrea" style="display:none">
                                        <td colspan="2">
                                            <input class="form-control" type="text" name="observacion9" placeholder="Escriba la observacion" id="9">
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="10" id="mangueraok" value="OK" required>
                                                    <label class="form-check-label" for="mangueraok">OK</label>

                                                    <input class="form-check-input" type="radio" name="10" id="mangueraobs" value="Fallo">
                                    ...
                                    <tr id="observacionmanguera" style="display:none">
                                        <td colspan="2">
                                            <input class="form-control" type="text" name="observacion10" placeholder="Escriba la observacion" id="10">
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="11" id="fugaaceiteok" value="OK" required>
                                                    <label class="form-check-label" for="fugaaceiteok">OK</label>

                                                    <input class="form-check-input" type="radio" name="11" id="fugaaceiteobs" value="Fallo">
                                    ...
                                    <tr id="observacionfugaaceite" style="display:none">
                                        <td colspan="2">
                                            <input class="form-control" type="text" name="observacion11" placeholder="Escriba la observacion" id="11">
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="12" id="fugacombusok" value="OK" required>
                                                    <label class="form-check-label" for="fugacombusok">OK</label>

                                                    <input class="form-check-input" type="radio" name="12" id="fugacombusobs" value="Fallo">
                                    ...
                                    <tr id="observacionfugaacombustible" style="display:none">
                                        <td colspan="2">
                                            <input class="form-control" type="text" name="observacion12" placeholder="Escriba la observacion" id="12">
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="13" id="fugaaguaok" value="OK" required>
                                                    <label class="form-check-label" for="fugaaguaok">OK</label>

                                                    <input class="form-check-input" type="radio" name="13" id="fugaaguaobs" value="Fallo">
                                    ...
                                    <tr id="observacionfugaagua" style="display:none">
                                        <td colspan="2">
                                            <input class="form-control" type="text" name="observacion13" placeholder="Escriba la observacion" id="13">
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="14" id="funfrenosok" value="OK" required>
                                                    <label class="form-check-label" for="funfrenosok">OK</label>

                                                    <input class="form-check-input" type="radio" name="14" id="funfrenosobs" value="Fallo">
                                    ...
                                    <tr id="observacionfunfrenos" style="display:none">
                                        <td colspan="2">
                                            <input class="form-control" type="text" name="observacion14" placeholder="Escriba la observacion" id="14">
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="15" id="frenoemergenciaok" value="OK" required>
                                                    <label class="form-check-label" for="frenoemergenciaok">OK</label>

                                                    <input class="form-check-input" type="radio" name="15" id="frenoemergenciaobs" value="Fallo">
                                    ...
                                    <tr id="observacionfrenoemergencia" style="display:none">
                                        <td colspan="2">
                                            <input class="form-control" type="text" name="observacion15" placeholder="Escriba la observacion" id="15">
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="16" id="direccionok" value="OK" required>
                                                    <label class="form-check-label" for="direccionok">OK</label>

                                                    <input class="form-check-input" type="radio" name="16" id="direccionobs" value="Fallo">
                                    ...
                                    <tr id="observaciondireccion" style="display:none">
                                        <td colspan="2">
                                            <input class="form-control" type="text" name="observacion16" placeholder="Escriba la observacion" id="16">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Suspension</td>
                                        <td>
                                            <div class="input-group">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="17" id="suspensionok" value="OK" required>
                                                    <label class="form-check-label" for="suspensionok">OK</label>

                                                    <input class="form-check-input" type="radio" name="17" id="suspensionobs" value="Fallo">
                                    ...
                                    <tr id="observacionsuspension" style="display:none">
                                        <td colspan="2">
                                            <input class="form-control" type="text" name="observacion17" placeholder="Escriba la observacion" id="17">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Clutch</td>
                                        <td>
                                            <div class="input-group">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="18" id="cluctchok" value="OK" required>
                                                    <label class="form-check-label" for="cluctchok">OK</label>

                                                    <input class="form-check-input" type="radio" name="18" id="cluctchobs" value="Fallo">
                                    ...
                                    <tr id="observacioncluctch" style="display:none">
                                        <td colspan="2">
                                            <input class="form-control" type="text" name="observacion18" placeholder="Escriba la observacion" id="18">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Transmision</td>
                                        <td>
                                            <div class="input-group">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="19" id="transmisionok" value="OK" required>
                                                    <label class="form-check-label" for="transmisionok">OK</label>

                                                    <input class="form-check-input" type="radio" name="19" id="transmisionobs" value="Fallo">
                                    ...
                                    <tr id="observaciontransmision" style="display:none">
                                        <td colspan="2">
                                            <input class="form-control" type="text" name="observacion19" placeholder="Escriba la observacion" id="19">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Muelles</td>
                                        <td>
                                            <div class="input-group">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="20" id="muellesok" value="OK" required>
                                                    <label class="form-check-label" for="muellesok">OK</label>

                                                    <input class="form-check-input" type="radio" name="20" id="muellesobs" value="Fallo">
                                    ...
                                    <tr id="observacionmuelle" style="display:none">
                                        <td colspan="2">
                                            <input class="form-control" type="text" name="observacion20" placeholder="Escriba la observacion" id="20">
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="21" id="conosok" value="OK" required>
                                                    <label class="form-check-label" for="conosok">OK</label>

                                                    <input class="form-check-input" type="radio" name="21" id="conosobs" value="Fallo">
                                    ...
                                    <tr id="observacionconos" style="display:none">
                                        <td colspan="2">
                                            <input class="form-control" type="text" name="observacion21" placeholder="Escriba la observacion" id="21">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Extintor</td>
                                        <td>
                                            <div class="input-group">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="22" id="extintorok" value="OK" required>
                                                    <label class="form-check-label" for="extintorok">OK</label>

                                                    <input class="form-check-input" type="radio" name="22" id="extintorobs" value="Fallo">
                                    ...
                                    <tr id="observacionextintor" style="display:none">
                                        <td colspan="2">
                                            <input class="form-control" type="text" name="observacion22" placeholder="Escriba la observacion" id="22">
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="23" id="crucetaok" value="OK" required>
                                                    <label class="form-check-label" for="crucetaok">OK</label>

                                                    <input class="form-check-input" type="radio" name="23" id="crucetaobs" value="Fallo">
                                    ...
                                    <tr id="observacioncruceta" style="display:none">
                                        <td colspan="2">
                                            <input class="form-control" type="text" name="observacion23" placeholder="Escriba la observacion" id="23">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Tacos</td>
                                        <td>
                                            <div class="input-group">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="24" id="tacosok" value="OK" required>
                                                    <label class="form-check-label" for="tacosok">OK</label>

                                                    <input class="form-check-input" type="radio" name="24" id="tacosobs" value="Fallo">
                                    ...
                                    <tr id="observaciontacos" style="display:none">
                                        <td colspan="2">
                                            <input class="form-control" type="text" name="observacion24" placeholder="Escriba la observacion" id="24">
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="25" id="señalesok" value="OK" required>
                                                    <label class="form-check-label" for="señalesok">OK</label>

                                                    <input class="form-check-input" type="radio" name="25" id="señalesobs" value="Fallo">
                                    ...
                                    <tr id="observacionseñales" style="display:none">
                                        <td colspan="2">
                                            <input class="form-control" type="text" name="observacion25" placeholder="Escriba la observacion" id="25">
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="26" id="Herramientaok" value="OK" required>
                                                    <label class="form-check-label" for="Herramientaok">OK</label>

                                                    <input class="form-check-input" type="radio" name="26" id="Herramientaobs" value="Fallo">
                                    ...
                                    <tr id="observacionherramienta" style="display:none">
                                        <td colspan="2">
                                            <input class="form-control" type="text" name="observacion26" placeholder="Escriba la observacion" id="26">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Botiquin</td>
                                        <td>
                                            <div class="input-group">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="27" id="botiquinok" value="OK" required>
                                                    <label class="form-check-label" for="botiquinok">OK</label>

                                                    <input class="form-check-input" type="radio" name="27" id="botiquinobs" value="Fallo">
                                    ...
                                    <tr id="observacionbotiquin" style="display:none">
                                        <td colspan="2">
                                            <input class="form-control" type="text" name="observacion27" placeholder="Escriba la observacion" id="27">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Linterna</td>
                                        <td>
                                            <div class="input-group">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="28" id="linternaok" value="OK" required>
                                                    <label class="form-check-label" for="linternaok">OK</label>

                                                    <input class="form-check-input" type="radio" name="28" id="linternaobs" value="Fallo">
                                    ...
                                    <tr id="observacionlinterna" style="display:none">
                                        <td colspan="2">
                                            <input class="form-control" type="text" name="observacion28" placeholder="Escriba la observacion" id="28">
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="29" id="vidriosok" value="OK" required>
                                                    <label class="form-check-label" for="vidriosok">OK</label>

                                                    <input class="form-check-input" type="radio" name="29" id="vidriosobs" value="Fallo">
                                    ...
                                    <tr id="observacionvidrio" style="display:none">
                                        <td colspan="2">
                                            <input class="form-control" type="text" name="observacion29" placeholder="Escriba la observacion" id="29">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Cojineria</td>
                                        <td>
                                            <div class="input-group">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="30" id="cojineriaok" value="OK" required>
                                                    <label class="form-check-label" for="cojineriaok">OK</label>

                                                    <input class="form-check-input" type="radio" name="30" id="cojineriaobs" value="Fallo">
                                    ...
                                    <tr id="observacioncojineria" style="display:none">
                                        <td colspan="2">
                                            <input class="form-control" type="text" name="observacion30" placeholder="Escriba la observacion" id="30">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Puertas</td>
                                        <td>
                                            <div class="input-group">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="31" id="puertasok" value="OK" required>
                                                    <label class="form-check-label" for="puertasok">OK</label>

                                                    <input class="form-check-input" type="radio" name="31" id="puertasobs" value="Fallo">
                                    ...
                                    <tr id="observacionpuertas" style="display:none">
                                        <td colspan="2">
                                            <input class="form-control" type="text" name="observacion31" placeholder="Escriba la observacion" id="31">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Espejos</td>
                                        <td>
                                            <div class="input-group">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="32" id="espejosok" value="OK" required>
                                                    <label class="form-check-label" for="espejosok">OK</label>

                                                    <input class="form-check-input" type="radio" name="32" id="espejosobs" value="Fallo">
                                    ...
                                    <tr id="observacionespejos" style="display:none">
                                        <td colspan="2">
                                            <input class="form-control" type="text" name="observacion32" placeholder="Escriba la observacion" id="32">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Plumillas</td>
                                        <td>
                                            <div class="input-group">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="33" id="plumillasok" value="OK" required>
                                                    <label class="form-check-label" for="plumillasok">OK</label>

                                                    <input class="form-check-input" type="radio" name="33" id="plumillasobs" value="Fallo">
                                    ...
                                    <tr id="observacionplumillas" style="display:none">
                                        <td colspan="2">
                                            <input class="form-control" type="text" name="observacion33" placeholder="Escriba la observacion" id="33">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Portaequipaje</td>
                                        <td>
                                            <div class="input-group">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="34" id="portaequipajeok" value="OK" required>
                                                    <label class="form-check-label" for="portaequipajeok">OK</label>

                                                    <input class="form-check-input" type="radio" name="34" id="portaequipajeobs" value="Fallo">
                                    ...
                                    <tr id="observacionportaequipaje" style="display:none">
                                        <td colspan="2">
                                            <input class="form-control" type="text" name="observacion34" placeholder="Escriba la observacion" id="34">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Sin golpes</td>
                                        <td>
                                            <div class="input-group">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="35" id="singolpesok" value="OK" required>
                                                    <label class="form-check-label" for="singolpesok">OK</label>

                                                    <input class="form-check-input" type="radio" name="35" id="singolpesobs" value="Fallo">
                                    ...
                                    <tr id="observacionsingolpe" style="display:none">
                                        <td colspan="2">
                                            <input class="form-control" type="text" name="observacion35" placeholder="Escriba la observacion" id="35">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Techo</td>
                                        <td>
                                            <div class="input-group">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="36" id="techook" value="OK" required>
                                                    <label class="form-check-label" for="techook">OK</label>

                                                    <input class="form-check-input" type="radio" name="36" id="techoobs" value="Fallo">
                                    ...
                                    <tr id="observaciontecho" style="display:none">
                                        <td colspan="2">
                                            <input class="form-control" type="text" name="observacion36" placeholder="Escriba la observacion" id="36">
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="37" id="cinturonesok" value="OK" required>
                                                    <label class="form-check-label" for="cinturonesok">OK</label>

                                                    <input class="form-check-input" type="radio" name="37" id="cinturonesobs" value="Fallo">
                                    ...
                                    <tr id="observacioncinturones" style="display:none">
                                        <td colspan="2">
                                            <input class="form-control" type="text" name="observacion37" placeholder="Escriba la observacion" id="37">
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="38" id="bateriaok" value="OK" required>
                                                    <label class="form-check-label" for="bateriaok">OK</label>

                                                    <input class="form-check-input" type="radio" name="38" id="bateriaobs" value="Fallo">
                                    ...
                                    <tr id="observacionbaterias" style="display:none">
                                        <td colspan="2">
                                            <input class="form-control" type="text" name="observacion38" placeholder="Escriba la observacion" id="38">
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="39" id="aireaconok" value="OK" required>
                                                    <label class="form-check-label" for="aireaconok">OK</label>

                                                    <input class="form-check-input" type="radio" name="39" id="aireaconobs" value="Fallo">
                                    ...
                                    <tr id="observacionaireacondicionado" style="display:none">
                                        <td colspan="2">
                                            <input class="form-control" type="text" name="observacion39" placeholder="Escriba la observacion" id="39">
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="40" id="compresorok" value="OK" required>
                                                    <label class="form-check-label" for="compresorok">OK</label>

                                                    <input class="form-check-input" type="radio" name="40" id="compresorobs" value="Fallo">
                                    ...
                                    <tr id="observacioncompresor" style="display:none">
                                        <td colspan="2">
                                            <input class="form-control" type="text" name="observacion40" placeholder="Escriba la observacion" id="40">
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="41" id="lucesybombillook" value="OK" required>
                                                    <label class="form-check-label" for="lucesybombillook">OK</label>

                                                    <input class="form-check-input" type="radio" name="41" id="lucesybombilloobs" value="Fallo">
                                    ...
                                    <tr id="observacionlucesybombillos" style="display:none">
                                        <td colspan="2">
                                            <input class="form-control" type="text" name="observacion41" placeholder="Escriba la observacion" id="41">
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="42" id="medidoresok" value="OK" required>
                                                    <label class="form-check-label" for="medidoresok">OK</label>

                                                    <input class="form-check-input" type="radio" name="42" id="medidoresobs" value="Fallo">
                                    ...
                                    <tr id="observacionmedidores" style="display:none">
                                        <td colspan="2">
                                            <input class="form-control" type="text" name="observacion42" placeholder="Escriba la observacion" id="42">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Otro</td>
                                        <td>
                                            <div class="input-group">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="43" id="otrook" value="OK" required>
                                                    <label class="form-check-label" for="otrook">OK</label>

                                                    <input class="form-check-input" type="radio" name="43" id="otroobs" value="Fallo">
                                    ...
                                    <tr id="observacionotro" style="display:none">
                                        <td colspan="2">
                                            <input class="form-control" type="text" name="observacion43" placeholder="Escriba la observacion" id="43">
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-xs-6 col-sm-3">
                        ...
                        <select class="form-control select2" id="tipo_lavado" name="tipo_lavado" class="select" multiple="multiple">
                            <option value="">[Seleccione..]</option>
