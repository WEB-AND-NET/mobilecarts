...
<br />
<div class="box ">
    <form id="form1" class="form" action="<?= $patch; ?>vehiculos_propietario/save" method="post" name="form1">
        <div class="box-body">
                ...
                <div class="clearfix"></div><br />
                    ...
                    <div class="col-lg-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control pull-right" value="<? //= $a->n_contra; 
                                                                                        ?>" id="n_contra" name="n_contra">
                        </div>
                    </div>
                    <div class="col-lg-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control pull-right" value="<? //= $a->v_contra; 
                                                                                        ?>" id="v_contra" name="v_contra">
                        </div>
                    </div>
                    <div class="col-lg-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control pull-right" value="<? //= $a->n_extra; 
                                                                                        ?>" id="n_extra" name="n_extra">
                        </div>
                    </div>
                    <div class="col-lg-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control pull-right" value="<? //= $a->v_extra; 
                                                                                        ?>" id="v_extra" name="v_extra">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control pull-right" value="<? //= $a->n_todo; 
                                                                                        ?>" id="n_todo" name="n_todo">
                        </div>
                    </div>
                    <div class="col-lg-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control pull-right" value="<? //= $a->v_todo; 
                                                                                        ?>" id="v_todo" name="v_todo">
                        </div>
                    </div>
                </fieldset>      -->
                    <div class="clearfix"></div>
...
<script type="text/javascript">
    ...
    function validarConductor() {
        $("#form1").mask("Espere...");
        $.post('<?= $patch; ?>vehiculos_propietario/validarConductores', {
    ...
    function AddItemE() {
        $("#form1").mask("Espere...");
        $.post(
            '<?= $patch; ?>vehiculos_propietario/getitems', {
    ...
    function loadItems() {
        $.post('<?= $patch; ?>vehiculos_propietario/load', {}, function(data) {
            $('#items').html(data);
        });
    }
    ...
    function delItem(i) {
        $("#form1").mask("Espere...");
        $.post('<?= $patch; ?>vehiculos_propietario/delete', {
            index: i
        }, function(data) {
            $("#form1").unmask();
            $('#items').html(data);
    ...
    function validar() {
        $("#form1").mask("Espere...");
        $.post('<?= $patch; ?>vehiculos_propietario/validar', {
                plac: $('#placa').val(),
                id: $("#id").val()
            },
            function(data) {
    ...
    $('#btn-cancel').click(function() {
        $.post('<?= $patch; ?>vehiculos_propietario/clean', {}, function(data) {
            window.location = '<?= $patch; ?>vehiculos_propietario';
        });
    });
</script>