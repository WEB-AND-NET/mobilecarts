            ...
            <ul class="nav navbar-nav">
                <li class="dropdown messages-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <span id="push-documentos-i" class="label label-danger">0</span>
                    </a>
                    <ul class="dropdown-menu">
                        <li>
                            <!-- inner menu: contains the actual data -->
                            <ul id="push-documentos" class="menu">
                                <li></li>
                            </ul>
                        </li>
                        <li id="footer-documentos" class="header">
                            <a href="#">No tienes Notificaciones</a>
                        </li>
                    </ul>
                </li>
