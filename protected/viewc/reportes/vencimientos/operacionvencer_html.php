...
<section class="content-header">
    <h1>
        Vehiculos con Tarjeta Operación por vencer
    </h1>
    <ol class="breadcrumb">
        <li><a href="<?= $patch ?>">Inicio</a></li>
        <li><a href="<?= $patch ?>operacionvencer">Tarjeta Operación por Vencer</a></li>
    </ol>
</section>
            ...
            <div class="box">
                <div class="box-body">
                    <div class="mailbox-controls" style="float:right;">
                        <!-- Check all button -->
                        <div class="btn-group">                           
                            <a href="<?= $patch; ?>operacionvencer/save/<?= $fi; ?>/<?= $ff; ?>" id="btn-pdf"class="btn btn-default btn-md" target="_blank"><i class="fa fa-file-text-o"></i><br/><span>PDF</span></a>                            
                        </div><!-- /.btn-group -->
                    </div>
                    ...
                    <table id="tabledatas" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                <th>&nbsp;</th>
                                <th>Placa</th>
                                <th>Tarjeta Operación(Mes/Día/Año)</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
