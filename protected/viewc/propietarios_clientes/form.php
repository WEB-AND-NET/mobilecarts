...
<br/>
<div class="box ">
    <form id="form1" class="form" action="<?= $patch; ?>clientes_pro/save" method="post" name="form1">
        <div class="box-body">
            <fieldset style="width:97%;">
                <legend>Contratante</legend>
                
                
                <input type="hidden" value='<?= $data["id_usuario"] ?>' name='id_usuario' id='id_usuario'> 
                <div class="col-lg-4">
...
<script type="text/javascript">
    ...
    function validar() {
        ...
        $.post('<?= $patch; ?>clientesp/validar', 
            {
                id_propietario: $('#id_usuario').val(), ced: $('#identificacion').val(), id: $("#id").val()
            },
            function (data) {
                $("#form1").unmask();
                if (data) {
