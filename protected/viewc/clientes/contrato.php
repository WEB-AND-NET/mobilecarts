...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $("#btn-add-vehiculo").click(function(){
            ...
            $.post("<?php echo $patch ?>clientes/contratos/vehiculo/add",{id_vehiculo:$("#vehiculo").val(),id_cliente:$("#id_cli").val()},function(response){table.ajax.reload();})
        })
    ...
    //            "bSort": false
            ...
            function updateItem(i) {       
                /*$("#form1").mask("Espere...");
                $.post('<?//= $patch; ?>clientes/contratos/update_tarifa', {index: i,valor :  $('#valor_edit_' + i).val()}, function (data) {
                    $("#form1").unmask();
                    $('#items').html(data);
                });*/
            }
            function delItem(i) {
                $("#form1").mask("Espere...");
                $.post('<?= $patch; ?>clientes/contratos/delete_tarifa', {index: i}, function (data) {
                    $("#form1").unmask();
                    //$('#items').html(data);
...
//    function loadItems() {
//        $.post('<?//= $patch; ?>clientes/contratos/load_tarifas', {}, function (data) {
//            $('#items').html(data);
//        });
//    }
