...
<script type="text/javascript">
    ...
    //            "sPaginationType": "full_numbers",
                ...
                "bProcessing": true,
                "bServerSide": true,
                //"sAjaxSource": "<?//= $patch; ?>clientes/contactos/paginate/<?//= ($a->id == "" ? 0 : $a->id); ?>",
        ...
        //                //cargarContactos();
            ...
            function editContacto(item){                       
                $.post('<?= $patch; ?>clientes/edit/contacto',
                    { id_contacto : item, id_cliente: $("#id").val() },
                    function (data) {
                        $('#c_id').val(data.id);
    ...
    //     Agregar un nuevo contacto de costo a la grilla
        function AddContacto() {
            ...
            $.post('<?= $patch; ?>clientes/getcontactos',
                {id_cliente:  $("#id").val(),c_id: $('#c_id').val(), c_identificacion: $('#c_identificacion').val(), c_nombre: $('#c_nombre').val(), c_cargo: $('#c_cargo').val(), c_ccosto: $('#c_ccosto').val(), c_ccosto_des: $('#c_ccosto option:selected').attr('data_des'), c_telefono: $('#c_telefono').val(), c_celular: $('#c_celular').val(), c_direccion: $('#c_direccion').val(), c_email: $('#c_email').val()},
                function (data) {
                    $("#form1").unmask();
                }, 'json'
            );
