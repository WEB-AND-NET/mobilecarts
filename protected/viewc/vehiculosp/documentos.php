...
<section class="content-header">
    <h1>
        Documentos de vehiculo <?php echo $data['vehiculo']->marca; ?>
    </h1>
    <ol class="breadcrumb">
        <li><a href="<?= $patch ?>">Inicio</a></li>
        <li class="active">Documentos de vehiculo <?php echo $data['vehiculo']->marca; ?></li>
    </ol>
</section>
            ...
            <div class="box">
                <div class="box-body">
                    <div class="mailbox-controls" style="float:right;">
                        <!-- Check all button -->
                        <div class="btn-group">
                            <a href="<?= $patch; ?>vehiculos_propietario/documentos/<?php echo $data['id']?>" id="btn-documents"class="btn btn-default btn-md"><i class="fa fa-archive"></i><br/><span>Editar Documentos</span></a>
                            <a href="#" id="btn-activate"class="btn btn-default btn-md"><i class="fa fa-check"></i><br/><span>Activar</span></a>
...
<script type="text/javascript">
     ...
     $('#btn-activate').click(function (e) {
        ...
        if (!item) {
          ...
          //  $("#exampleModalLong").modal("close");
            ...
            var id_vehiculo = "<?php echo $data['vehiculo']->id ?>";
            var url = "<?php echo Doo::conf()->APP_URL?>vehiculos/documents/activar";
            $.post(url,{"id_doc":item,"id_vehiculo":id_vehiculo},function(res){
                location.href = "<?php echo Doo::conf()->APP_URL?>vehiculos/documents/view/"+id_vehiculo;
            })
    ...
    $("#env-rechazo").click(function(e){
        e.preventDefault()
        var url = "<?php echo Doo::conf()->APP_URL?>vehiculos/documents/rechazar";
        var id_doc = $("#id_doc_r").val()
        var id_vehiculo = "<?php echo $data['vehiculo']->id ?>";
        var documento = $("#documento_r").val()
        var comentario = $("#comentario_r").val()
        var notify = $("#notitify")[0].checked ? "1" : "0";
        $.post(url,{id_doc,id_vehiculo, documento,comentario,notify},function(res){
            location.href = "<?php echo Doo::conf()->APP_URL?>vehiculos/documents/view/"+id_vehiculo;
            //console.log(res);
        })
    })
