            ...
            <fieldset style="width:97%;">
                ...
                <fieldset>
                    ...
                    <table id="tabledatas" class="table table-bordered table-striped">
                        ...
                        <tbody id="items">
                            <tr><td class="ch-message-information" colspan="2">Cargando lista de vehiculos</td></tr>
                        </tbody>
                        <tfoot>
                            <tr>
                                <th>&nbsp;</th>
...
<script type="text/javascript">
    ...
    function AddVehiculo() {
        $("#form1").mask("Espere...");
        $.post(
            '<?= $patch; ?>convenios/insert_vehiculo', {id_vehiculo: $('#id_list_vehiculo').val(), placa: $('#id_list_vehiculo option:selected').text()},
            function (data) {
                $("#form1").unmask();
                $('#items').html(data);
            }
    ...
    function delItem(i) {
        $("#form1").mask("Espere...");
        $.post('<?= $patch; ?>convenios/delete_vehiculo', {index: i}, function (data) {
            $("#form1").unmask();
            $('#items').html(data);
        });
    }
