...
<section class="content-header">
    <h1>
        <?= ($a->id == "" ? 'Registro' : 'Actualizaci&oacute;n'); ?> de Ordenes de servicio
    </h1>
    <ol class="breadcrumb">
            ...
            <fieldset style="width:97%;">
                ...
                <fieldset class="col-lg-8">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="hidden" class="input-precios form-control pull-right" maxlength="15"  id="valor" name="valor" value="<?= $a->valor == "" ? '0' : $a->valor ?>" readonly="">
                        </div><!-- /.input group -->                   
                    </div> 
                    <div class="col-lg-6">
                        ...
                        <div class="input-group">-->
                            <!--<span style="border:0px;font-size: 25px;" class="input-group-addon"><i class="fa fa-dollar"></i></span>-->
                            <input type="hidden" class="input-precios form-control pull-right" maxlength="15" id="sobre_tasa" name="sobre_tasa" value="<?= $a->sobre_tasa == "" ? '0' : $a->sobre_tasa ?>">
                ...
                <div id="renderparadas" style="display: block;">
                    <div class="col-lg-4" id="paradas">
                        ...
                        <input type="hidden" id="barrios" name="barrios">
                        <div class="input-group">
                            <!--<div class="input-group-addon">
                                <i class="fa fa-location-arrow"></i>
                            </div>-->
                            <!--<select class="form-control select2" id="barrios" name="barrios" style="visibility: hidden;">-->
                                <!--<option value="">[Seleccione..]</option>-->
...
<script type="text/javascript">
    ...
    function changeCliente() {
        ...
        $.post('<?= $patch ?>ordenes_servicios/cargarvhp', {id_cliente: id_client, id_vh: '<?= $a->id_vehiculo ?>'}, function (data) {
            $("#id_vehiculo").html(data);
           console.log(data);
        });
...
//            alert(send.tipo+" - "+send.nhora+" - "+idCl);
    ...
    function AddItemE() {
        $("#form1").mask("Espere...");
        $.post(
            '<?= $patch; ?>ordenes_servicios/getitems', {id_cond: $('#id_list_conductor').val()},
            function (data) {
                $("#form1").unmask();
                $('#items').html(data);
            }
