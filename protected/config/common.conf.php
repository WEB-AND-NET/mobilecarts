...
$config['SITE_PATH'] = realpath('..').'/aguas.mobilecarts/';
 ...
 */
//$config['pagesize'] = 10;
$config['DOC'] = $_SERVER['DOCUMENT_ROOT'].$config['SUBFOLDER'].'documentacion/';
$config['IMG_DIR'] = $_SERVER['DOCUMENT_ROOT'].$config['SUBFOLDER'].'/global/img/';