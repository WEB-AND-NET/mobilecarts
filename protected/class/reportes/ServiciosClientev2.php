...
/**
 * Description of ServiciosClientev2
 * 
 * @author Carlos Meriño Iriarte <carlos.merino.iriarte@gmail.com>
 */
class ServiciosClientev2 extends FPDF {

    public function __construct() {
        parent::__construct('L', 'mm', 'merry');
...
//        $this->Cell(80, 35, $this->Image('global/img/logo.png', $this->GetX(), $this->GetY(), 80, 35), 0, 1, 'C');
        ...
        $this->Cell(335+$obs_w, 5, utf8_decode('SERVICIOS DE CLIENTE'), 0, 1, 'R');
        $this->Cell(66, 5, utf8_decode("NIT ".C_NIT_DIGITO), 0, 0, 'L');
        $this->Cell(335+$obs_w, 5, utf8_decode($cliente["nombre"]), 0, 1, 'R');
        $this->Cell(66, 5, "", 0, 0, 'L');
        $this->Cell(335+$obs_w, 5,utf8_decode("IDENTIFICACIÓN ").$cliente["identificacion"], 0, 1, 'R');
        $this->Cell(66, 5, "", 0, 0, 'L');
        $this->Cell(335+$obs_w, 5, "CONTRATO ".$cliente["numero"], 0, 1, 'R');
        $this->Cell(66, 5, "", 0, 0, 'L');
        $this->Cell(335+$obs_w, 5, "DE $fi A $ff", 0, 1, 'R');
        ...
        if(count($servicios) < 1){
            ...
            $this->Cell(35, 5, utf8_decode('VEHICULO'), 1, 0, 'C');
            $this->Cell($obs_w, 5, utf8_decode('OBSERVACIÓN'), 1, 1, 'C');

            $this->SetFont('Arial', '', 9);
            
            $this->SetWidths(array(30, 30, 50, 50, 25, 30, 30, 45, 40, 35, 35, $obs_w));
