 ...
 */
(function(o,g){var n={};
n.version="0.4.1";n.settings={currency:{symbol:"$",format:"%s%v",decimal:".",thousand:",",precision:0,grouping:3},number:{precision:0,grouping:3,thousand:",",decimal:"."}};
...
};var d=n.formatNumber=n.format=function(t,w,z,v){if(k(t)){return a(t,function(A){return d(A,w,z,v);});}t=i(t);var r=h((q(w)?w:{precision:w,thousand:z,decimal:v}),n.settings.number),x=l(r.precision),u=t<0?"-":"",s=parseInt(b(Math.abs(t||0),x),10)+"",y=s.length>3?s.length%3:0;
